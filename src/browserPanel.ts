...
export class BrowserPanel {
  ...
  showSlides(url: string) {
    ...
    const showNotes = config.get<boolean>('showNotes', true);
    const enforceSteps = config.get<boolean>('enforceStepCompletion', true);
    const followMotion = config.get<boolean>('followVSCodeMotion', true);
